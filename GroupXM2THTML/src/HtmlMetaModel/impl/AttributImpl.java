 ...
 * </p>
 * <ul>
 *   <li>{@link HtmlMetaModel.impl.AttributImpl#getNom_attr <em>Nom attr</em>}</li>
 *   <li>{@link HtmlMetaModel.impl.AttributImpl#getContenu <em>Contenu</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributImpl extends MinimalEObjectImpl.Container implements Attribut {
	...
	protected EClass eStaticClass() {
		return HtmlMetaModelPackage.Literals.ATTRIBUT;
	}
	...
	public EList<Attr_Type> getNom_attr() {
		if (nom_attr == null) {
			nom_attr = new EDataTypeUniqueEList<Attr_Type>(Attr_Type.class, this, HtmlMetaModelPackage.ATTRIBUT__NOM_ATTR);
		}
		return nom_attr;
	}
	...
	public void setContenu(String newContenu) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HtmlMetaModelPackage.ATTRIBUT__CONTENU, oldContenu, contenu));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HtmlMetaModelPackage.ATTRIBUT__NOM_ATTR:
				return getNom_attr();
			case HtmlMetaModelPackage.ATTRIBUT__CONTENU:
				return getContenu();
		}

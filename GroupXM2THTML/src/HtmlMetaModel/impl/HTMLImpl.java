 ...
 * </p>
 * <ul>
 *   <li>{@link HtmlMetaModel.impl.HTMLImpl#getBalise <em>Balise</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HTMLImpl extends MinimalEObjectImpl.Container implements HTML {
	...
	protected EClass eStaticClass() {
		return HtmlMetaModelPackage.Literals.HTML;
	}
	...
	public EList<Balise> getBalise() {
		if (balise == null) {
			balise = new EObjectContainmentEList<Balise>(Balise.class, this, HtmlMetaModelPackage.HTML__BALISE);
		}
		return balise;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HtmlMetaModelPackage.HTML__BALISE:
